...
def autocycle(logfile=''):
	'''
	This is a function to run a MINI fridge cycle.  Note that it takes ??? hours to run.
	'''
	try:
		...
		print 'Turning UC pump to 5.30 V and wait 5 minutes'
		...
		time.sleep(300)
        '''
		print 'Setting He4 pump to 0.0 V and wait 5 minutes'
